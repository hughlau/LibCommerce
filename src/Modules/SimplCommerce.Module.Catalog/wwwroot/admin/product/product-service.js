...
(function () {
    ...
    function productService($http, Upload) {
        ...
        function transferProductDocs(id) {
            return $http.post('api/products/trnasfer/'+id)
        }
